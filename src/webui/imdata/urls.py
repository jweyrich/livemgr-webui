...
from webui.imdata.controllers import profiles, settings, acls, badwords, \
	conversations, groups, users, buddies, dashboard, license

urlpatterns = patterns('webui.imdata.controllers',
	...
	url(r'^acls/+delete/+(?P<object_id>\d+)/*$', acls.delete, name='acls-delete'),
	# Users
...
#	url(r'^users/+delete/+(?P<object_id>\d+)/*$', users.delete, name='users-delete'),
	# Buddies
	...
	url(r'^groups/+delete/+(?P<object_id>\d+)/*$', groups.delete, name='groups-delete'),
	# Conversations
	...
	url(r'^badwords/+delete/+(?P<object_id>\d+)/*$', badwords.delete, name='badwords-delete'),
